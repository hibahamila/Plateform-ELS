...
//                     <input class="form-control response-input" type="text" name="reponses[${i}][contenu]" placeholder="Entrez la réponse ${i + 1}" required>
//                     <div class="invalid-feedback">Ce champ de réponse est obligatoire.</div>
//                 </div>
//                 <div class="col-md-4 d-flex align-items-center">
//                     <input type="hidden" name="reponses[${i}][est_correcte]" value="0">
//                     <input type="checkbox" name="reponses[${i}][est_correcte]" value="1" class="form-check-input me-2">
//                 </div>
//             `;
...
//         let enonceInput = document.getElementById("enonce");
//         if (enonceInput.value.trim() === "") {
//             isValid = false;
//             errorMessages.push("Veuillez entrer un énoncé valide.");
//             enonceInput.classList.add("is-invalid");
//             enonceInput.classList.remove("is-valid");
//         } else {
//             enonceInput.classList.remove("is-invalid");
//             enonceInput.classList.add("is-valid");
//         }
...
//         let responseFields = form.querySelectorAll('input[name^="reponses"][name$="[contenu]"]');
