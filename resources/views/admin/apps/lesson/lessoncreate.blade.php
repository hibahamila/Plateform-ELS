                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="duration" value="{{ old('duration') }}" placeholder="Durée (HH:mm)" pattern="\d{2}:\d{2}" title="Format: HH:mm" required />
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                @if (isset($chapitreId) && $chapitreId)
                                                ...
                                                @else
                                                    <select class="form-select select2-chapitre" name="chapitre_id" required>
                                                        ...
                                                        @foreach($chapitres as $chapitre)
                                                            <option value="{{ $chapitre->id }}" {{ old('chapitre_id') == $chapitre->id ? 'selected' : '' }}>{{ $chapitre->title }}</option>
                                                        @endforeach
                                                    </select>
                                                @endif
                                            </div>
