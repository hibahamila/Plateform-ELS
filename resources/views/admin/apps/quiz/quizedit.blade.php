                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="titre" value="{{ old('titre', $quiz->titre) }}" required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="date" name="date_limite" value="{{ old('date_limite', $quiz->date_limite) }}" required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="date" name="date_fin" value="{{ old('date_fin', $quiz->date_fin) }}" required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="score_minimum" value="{{ old('score_minimum', $quiz->score_minimum) }}" required>
