...
{{-- el code el 3edi menghir champs description fih fazet  --}}
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input id="title" class="form-control" type="text" name="title" placeholder="Titre" value="{{ old('title') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="start_date" class="form-control" type="date" name="start_date" value="{{ old('start_date') }}" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="end_date" class="form-control" type="date" name="end_date" value="{{ old('end_date') }}" required>
