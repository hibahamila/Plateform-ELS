...
<style>
    ...
    /* Pagination verte */
    #cours-table_wrapper .dataTables_wrapper .dataTables_paginate .paginate_button {
    ...
    #cours-table_wrapper .dataTables_wrapper .dataTables_paginate .paginate_button:hover {
        background-color: #28a745 !important;
        color: white !important;
        border: 1px solid #28a745 !important;
    }

    #cours-table_wrapper .dataTables_wrapper .dataTables_paginate .paginate_button.current,
    #cours-table_wrapper .dataTables_wrapper .dataTables_paginate .paginate_button.current:hover {
        background-color: #28a745 !important;
        color: white !important;
        border: 1px solid #28a745 !important;
    }
    ...
    #cours-table_wrapper .dataTables_wrapper .dataTables_paginate .paginate_button.disabled,
    #cours-table_wrapper .dataTables_wrapper .dataTables_paginate .paginate_button.disabled:hover {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="display" id="cours-table">
                            <thead>
                                <tr>
                                    <th>Titre</th>
                                    <th>Description</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#cours-table').DataTable({
            ...
            pageLength: 10,
            order: [[0, 'asc']] // Tri par défaut sur la première colonne (Titre)
        });
    });
</script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\PFE\plateformeEls\resources\views\admin\apps\cours\cours.blade.php ENDPATH**/ ?>