                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('questionedit', $question->id)); ?>" class="btn btn-warning btn-sm">Modifier</a>
                                    <form action="<?php echo e(route('questiondestroy', $question->id)); ?>" method="POST" style="display:inline;">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\OneDrive\Bureau\PFE\viho_admin_boilerplate\resources\views/admin/apps/question/questions.blade.php ENDPATH**/ ?>