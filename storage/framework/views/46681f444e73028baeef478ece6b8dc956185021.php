                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form theme-form">
                            <form action="<?php echo e(route('formationupdate', $formation->id)); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select2-categorie" name="categorie_id" required>
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($categorie->id); ?>" <?php echo e(old('categorie_id', $formation->categorie_id) == $categorie->id ? 'selected' : ''); ?>><?php echo e($categorie->titre); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php if($formation->image): ?>
                                                <div id="currentImageContainer" class="mb-3">
                                                    <img src="<?php echo e(asset('storage/' . $formation->image)); ?>" alt="image" width="250" class="d-block mb-2" />
                                            ...
                                            <?php endif; ?>
                                            <input class="form-control" type="file" name="image" id="imageUpload" style="<?php echo e($formation->image ? 'display: none;' : ''); ?>">
...
<!-- Appel du script JavaScript externe -->
<script src="<?php echo e(asset('assets/js/formations/formation-edit.js')); ?>"></script>
<?php $__env->stopPush(); ?>
