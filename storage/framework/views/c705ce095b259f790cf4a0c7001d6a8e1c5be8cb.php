                                        ...
                                        <td>
                                            <?php if($cour->formation): ?>
                                                <a href="<?php echo e(route('formationshow', $cour->formation->id)); ?>" class="text-primary">
                                                    <?php echo e($cour->formation->titre); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        let selectedCoursId = localStorage.getItem("selectedCoursId");
        if (selectedCoursId) {
            let selectedRow = document.querySelector(`tr[data-id="${selectedCoursId}"]`);
            if (selectedRow) {
                selectedRow.style.backgroundColor = "#f8d7da"; // Couleur de surbrillance
            }
        }
    });
</script>
