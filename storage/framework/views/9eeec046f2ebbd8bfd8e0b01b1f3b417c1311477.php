...
<?php $__env->startPush('css'); ?>
    ...
    <?php if(session()->has('chapitre_id')): ?>
    <p>Session chapitre_id: <?php echo e(session('chapitre_id')); ?></p>
    <?php endif; ?>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <?php if($selectedCoursId && request()->has('cours_id')): ?>
                                            ...
                                            <input type="text" class="form-control bg-light" value="<?php echo e($cours->find($selectedCoursId)->titre); ?>" readonly />
