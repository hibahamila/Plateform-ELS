        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Table pour afficher la liste des réponses -->
                        ...
                        <tbody>
                            <?php $__currentLoopData = $reponses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reponse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('reponseedit', $reponse->id)); ?>" class="btn btn-warning btn-sm">Modifier</a>
                                        <form action="<?php echo e(route('reponsedestroy', $reponse->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\OneDrive\Bureau\PFE\viho_admin_boilerplate\resources\views/admin/apps/reponse/reponses.blade.php ENDPATH**/ ?>