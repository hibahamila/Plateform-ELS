...
<div class="container d-flex justify-content-center">
    <div class="card p-4 shadow" style="max-width: 600px; width: 100%;">
        ...
        <form action="<?php echo e(route('questions.store')); ?>" method="POST" class="form theme-form">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-secondary px-4" type="button" onclick="window.location.href='<?php echo e(route('questions.index')); ?>'">Annuler</button>
