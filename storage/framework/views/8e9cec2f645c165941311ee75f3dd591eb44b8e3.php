...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('chapitres.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>

        <div class="form-group">
            <label for="titre">Titre</label>
            <input type="text" id="titre" name="titre" class="form-control" value="<?php echo e(old('titre')); ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select id="cours_id" name="cours_id" class="form-control" required>
                <?php $__currentLoopData = $cours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coursItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($coursItem->id); ?>" <?php echo e(old('cours_id') == $coursItem->id ? 'selected' : ''); ?>><?php echo e($coursItem->titre); ?></option>
